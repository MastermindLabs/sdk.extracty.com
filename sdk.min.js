...
#extracty-sdk-selection-overlay {
  font-family: 'Avenir', 'Arial', sans-serif;
  font-size: 14px;
}

.extracty-overlay.background-box {
...
.extracty-overlay.background-box a {
  cursor: auto !important;
}

.extracty-overlay .innerBox {
...
.extracty-overlay .innerBox p {
  margin: 5px 0;
}

.extracty-overlay .action {
  text-align: left
}

.extracty-overlay .action table {
  width: 500px;
...
.extracty-overlay .action table td {
	border-width: 1px;
	padding: 10px;
	border-style: dashed;
	border-color: gray;
...
.extracty-overlay .action table td:nth-child(1) {
  width: 100px;
  font-weight: 800;
}
.extracty-overlay .action table td:nth-child(2) {
  width: 400px;
}

.extracty-overlay ul.nav {
    margin: 0px;
    width: calc(100% - 36px);
}

.extracty-overlay .nav a, .extracty-overlay .nav li {
  color: #6b6b6b;
  text-decoration: none;
}

.extracty-overlay .dropDownActionSelector li, .dropDownActionSelector li a {
  cursor: pointer !important;
  z-index: 100;
}

.extracty-overlay .dropDownActionSelector {
  background: white;
  width: 100%;
  z-index: 500;
}

.extracty-overlay .nav {
  padding: 0;
  text-align: left;
  display: inline-block;
}
.extracty-overlay .nav > li::after {
    content: '▼';
    padding-left: 0.5em;
    color: #6b6b6b;
    font-size: 0.9em;
...
.extracty-overlay .nav > li:hover {
  background: white;
}

.extracty-overlay .drop {
  position: relative;
}
.extracty-overlay .drop ul {
  position: absolute;
  background-color: #white;
  left: 0;
  top: 3em;
...
.extracty-overlay .drop ul li {
  display: block;
  width: 100%;
}
.extracty-overlay .drop ul li a {
  width: 100%;
  padding: 1em 18px;
  display: inline-block;
  white-space: pre;
...
.extracty-overlay .drop ul li a:hover {
  background: #f2f2f2;
}
.extracty-overlay .drop:hover ul {
  -webkit-transform: scale(1);
          transform: scale(1);
}

.extracty-overlay .submitAction {
  margin-top: 20px;
...
.extracty-overlay .inputField .group 			  {
  position:relative;
  margin-bottom: 4px;
}
.extracty-overlay .inputField input 				{
  font-size: 14px;
...
.extracty-overlay .inputField input:focus 		{ outline:none; }

/* BOTTOM BARS ================================= */
.extracty-overlay .inputField .bar 	{
  position:relative;
  display:block;
  width: calc(100% - 19px);
  margin-left: 7px;
 }
.extracty-overlay .inputField .bar:before, .extracty-overlay .bar:after 	{
  content:'';
  height:1px;
  width:0;
  bottom:1px;
...
.extracty-overlay .inputField .bar:before {
  left:50%;
}
.extracty-overlay .inputField .bar:after {
  right:50%;
}

/* active state */
.extracty-overlay .inputField input:focus ~ .bar:before, input:focus ~ .bar:after {
  width:50%;
}
...
/* line 71, lib/css/extracty.css.scss */
...
/* line 136, lib/css/extracty.css.scss */
...
/* line 142, lib/css/extracty.css.scss */

div#extracty_main .extracty_input_field {
    display: block;
    float: left;
    margin: 0 7px 0 0;
...
/* line 161, lib/css/extracty.css.scss */

div#extracty_main .extracty_wizard .extracty_input_field {
...
/* line 167, lib/css/extracty.css.scss */

div#extracty_main .extracty_prompt {
...
/* line 174, lib/css/extracty.css.scss */

div#extracty_main .extracty_wizard #extracty_path_field {
    margin: 6px 0px;
    clear: both;
    float: none;
    display: block;
...
div#extracty_main input[type="button"] {
    border-radius: 4px;
    background-color: #439E43;
    border: none;
    color: white;
...
div#extracty_main input[type="button"].clearButton {
    background-color: #808080;
}

/* line 181, lib/css/extracty.css.scss */

.extracty_selected {
    background-color: rgb(151, 228, 120) !important;
    background-image: none !important;
    cursor: url(data:image/svg+xml;base64,), default !important;
}


/* line 186, lib/css/extracty.css.scss */
...
/* line 191, lib/css/extracty.css.scss */

.extracty_border {
    position: absolute !important;
    z-index: 999999 !important;
    background: white !important;
    background-color: #439E43 !important;
...
/* line 207, lib/css/extracty.css.scss */

.extracty_bottom_border {
...
/* line 212, lib/css/extracty.css.scss */
...
/* line 219, lib/css/extracty.css.scss */
...
/* line 225, lib/css/extracty.css.scss */

img.extracty_rejected {
    /*border: 5px solid #F00 !important;*/
}


/* line 229, lib/css/extracty.css.scss */

img.extracty_suggested {
    border: 5px solid #FF5 !important;
}


/* line 233, lib/css/extracty.css.scss */

img.extracty_selected {
    border: 5px solid #0F0 !important;
}


/* line 238, lib/css/extracty.css.scss */

#extracty_main.extracty_top {
    top: 5px !important;
}


/* line 242, lib/css/extracty.css.scss */

#extracty_main.extracty_bottom {
    bottom: 5px !important;
}


/* line 246, lib/css/extracty.css.scss */
...
/* line 251, lib/css/extracty.css.scss */
...
/* line 255, lib/css/extracty.css.scss */

#extracty_main .extracty_new_line {
    clear: both;
}


/* line 259, lib/css/extracty.css.scss */

#extracty_main .extracty_option {
    float: left;
}


/* line 263, lib/css/extracty.css.scss */

#extracty_main .extracty_selected_option {
    text-decoration: underline;
}`;var style=document.createElement('style');style.innerHTML=styleText;style.id="matermindStyleElement";document.getElementsByTagName('head')[0].appendChild(style);var selectedAction='';var clickEventHandler=function(event){if(selectedAction!=='Click element'){event.stopPropagation();event.preventDefault();return false;}};window.extractySDK={addJSCode:function(){var div=document.createElement('div');div.id='extracty-sdk-selection-overlay';div.class='extracty_ignore';document.getElementsByTagName('body')[0].appendChild(div);div.innerHTML=`
    <div class="background-box extracty-overlay extracty_ignore">
    <div class="innerBox">
      <p>Specify the JavaScript you want to get executed.</p>

      <div id="extracty-code-editor">console.log('Hello World');</div>

      <button class="submitAction">Add Execution</button>

    </div>

    </div>
    `;var editor=ace.edit("extracty-code-editor");var JavaScriptMode=ace.require("ace/mode/javascript").Mode;editor.session.setMode(new JavaScriptMode());document.querySelector('.background-box').addEventListener('click',function(){var box=document.querySelector('#extracty-sdk-selection-overlay');box.parentNode.removeChild(box);},false);document.querySelector('.innerBox').addEventListener('click',function(event){event.stopPropagation();},false);document.querySelector('.submitAction').addEventListener('click',function(){var d=document.querySelector('#extracty-code-editor .ace_content');var code=d.innerText||d.textContent;parent.postMessage({action:'addAction',object:{'property':code,'selector':'','action':'Execute code'}},"*");document.querySelector('#extracty-sdk-selection-overlay .innerBox').innerHTML=`
 <h3 style="margin-top: 127px; text-align: center; color: #439E43; font-size: 29px;">Step added!</h3>`;window.setTimeout(function(){var box=document.querySelector('#extracty-sdk-selection-overlay');box.parentNode.removeChild(box);window.extracty_extension.clearEverything();},500);});},addActionForSelector:function(selector){var div=document.createElement('div');div.id='extracty-sdk-selection-overlay';div.class='extracty_ignore';document.getElementsByTagName('body')[0].appendChild(div);div.innerHTML=`
<div class="background-box extracty-overlay">
    <div class="innerBox">
      <p>The selector matches <strong><span class="numberOfMatchingElements"></span></strong>
      element(s) of type <strong><span class="typeOfMatchingElements"></span></strong>.</p>
      ...
      <div class="action">
        <table>
          <tr>
            ...
            <td>
              <ul class="nav">
                <li class="drop"><span class="selectedAction">Extract text</span>
                  <ul class="dropDownActionSelector">
                  </ul>
                </li>
              </ul>
            </td>
          </tr>
          <tr class="additionalSettings" style="display: none"></tr>
        </table>
      </div>
      <button class="submitAction">Save action</button>

</div>
`;initTopText();addIgnoreClass();var actions=['Extract text','Click element'];selectedAction=actions[0];selectAction(actions[0]);var type=document.querySelector('#extracty-sdk-selection-overlay .typeOfMatchingElements').textContent;if(type==='input'||type==='textarea'){actions.push('Type input');}document.querySelector('.submitAction').addEventListener('click',function(){var property=document.querySelector('.actionProperty')?document.querySelector('.actionProperty').value:undefined;parent.postMessage({action:'addAction',object:{'property':property,'selector':selector,'action':selectedAction}},"*");if(selectedAction==='Click element'){var anchors=document.querySelectorAll('*');document.querySelector(selector).onclick='';document.querySelector(selector).click();document.querySelector(selector).onclick=clickEventHandler;}else if(selectedAction==='Type input'){document.querySelector(selector).value=document.querySelector('.actionProperty').value;}document.querySelector('#extracty-sdk-selection-overlay .innerBox').innerHTML=`
<h3 style="margin-top: 127px; text-align: center; color: #439E43; font-size: 29px;">Step added!</h3>`;window.setTimeout(function(){var box=document.querySelector('#extracty-sdk-selection-overlay');box.parentNode.removeChild(box);window.extracty_extension.clearEverything();},500);},false);document.querySelector('.background-box').addEventListener('click',function(){var box=document.querySelector('#extracty-sdk-selection-overlay');box.parentNode.removeChild(box);},false);document.querySelector('.innerBox').addEventListener('click',function(event){event.stopPropagation();},false);function selectAction(active){selectedAction=active;document.querySelector('.selectedAction').innerText=active;var html='';document.querySelector('.dropDownActionSelector').innerHTML=html;window.setTimeout(function(){actions.forEach(function(action){if(action!==active){html+=`<li><a>${action}</a></li>\n`;}});document.querySelector('.dropDownActionSelector').innerHTML=html;Array.prototype.slice.call(document.querySelectorAll('.dropDownActionSelector li a')).map(function(e){e.addEventListener('click',function(){selectAction(e.textContent);},false);});},200);if(selectedAction==='Extract text'){var additionalSettings=document.querySelector('.additionalSettings');additionalSettings.innerHTML=`
 <td><span>Name</span></td>
 <td class="inputField">
   <div class="group">
        <input type="text" class="actionProperty" value="extracted">
        <span class="bar"></span>
  </div>
</td>`;additionalSettings.style.display='';}else if(selectedAction==='Type input'){var additionalSettings=document.querySelector('.additionalSettings');additionalSettings.innerHTML=`
 <td><span>Input</span></td>
 <td class="inputField">
   <div class="group">
        <input type="text" class="actionProperty" value="Sample Text">
        <span class="bar"></span>
  </div>
</td>`;additionalSettings.style.display='';}else{document.querySelector('.additionalSettings').innerHTML='';}}function initTopText(){try{var length=document.querySelectorAll(selector).length;document.querySelector('#extracty-sdk-selection-overlay .numberOfMatchingElements').textContent=length;if(length>0){var elements=Array.prototype.slice.call(document.querySelectorAll(selector));var type=elements[0].tagName;elements.forEach(function(e){if(e.tagName!==type){type='mixed';}});type=type.toLowerCase();}else{type='No type detected.';}document.querySelector('#extracty-sdk-selection-overlay .typeOfMatchingElements').textContent=type;}catch(e){alert('Invalid css selector!');}}function addIgnoreClass(){Array.prototype.slice.call(document.querySelectorAll("#extracty-sdk-selection-overlay *")).map(function(e){e.className=e.className+' extracty_ignore';});}}};window.addEventListener("message",function(event){console.log('frame received',event);if(event.data.action==="clear"){window.extracty_extension.clearEverything();}else if(event.data.action==="reload"){window.location.reload();}else if(event.data.action==='click'){selectedAction='Click element';jQuerySG(event.data.selector).get(0).onclick='';jQuerySG(event.data.selector).get(0).click();jQuerySG(event.data.selector).get(0).onclick=clickEventHandler;selectedAction='';}else if(event.data.action==='enter text'){jQuerySG(event.data.selector).get(0).value=event.data.property;}},false);parent.postMessage({location:window.location.href.replace(/.*index.php\?/,'')},"*");// SELECTOR SCRIPT
;(function(){if(typeof extracty=='undefined'){/*!
...
},e.prototype.removeInterface=function(e){// return this.sg_div.remove(), this.sg_div = null
},e.prototype.unbind=function(e){var t;return t=e&&e.data&&e.data.self||this,t.unbound=!0,t.removeBorderFromDom(),t.clearSelected();},e.prototype.addJSCode=function(e){window.extractySDK.addJSCode();},e.prototype.sendSelector=function(e){window.extractySDK.addActionForSelector(document.querySelector('#extracty_path_field').value);},e.prototype.unbindAndRemoveInterface=function(e){var t;// return t = e && e.data && e.data.self || this, t.unbind(), t.removeInterface()
},e.prototype.setOutputMode=function(e,t){var n;return n=e&&e.data&&e.data.self||this,n.output_mode=e&&e.data&&e.data.mode||t;},e.prototype.rebind=function(){return this.unbound=!1,this.clearEverything(),this.setupBorders();},e.prototype.rebindAndMakeInterface=function(){return this.makeInterface(),this.rebind();},e.prototype.randBetween=function(e,t){return Math.floor(Math.random()*t)+e;},e.toggle=function(t){return window.extracty_extension=new e(),window.extracty_extension.makeInterface(),window.extracty_extension.clearEverything(),window.extracty_extension.setMode("interactive"),jQuerySG(".extracty_extension_loading").remove();},e;}();}.call(this);}window.injected=false;document.addEventListener('DOMContentLoaded',function(){var interval=setInterval(function(){if(typeof extracty!=='undefined'){if(window.injected){clearInterval(interval);}if(!window.injected){var anchors=document.querySelectorAll('*');for(var i=0;i<anchors.length;i++){anchors[i].onclick=clickEventHandler;}extracty.toggle();window.injected=true;}}},400);},false);// if (!document.querySelector('#extracty_main')) {
//   extracty.toggle();
// }
})();